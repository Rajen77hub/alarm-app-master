    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text('Enter title for the Alarm:', style: CustomTextStyle.customTextStyle(25),),
            TextField(
              onChanged: (text){
                title = text;
              },
              style: CustomTextStyle.customTextStyle(25),
            ),
...
void scheduleAlarm (String title, DateTime date)  async{
  ...
  var androidPlatformChannelSpecifics = AndroidNotificationDetails('alarm_notif', 'alarm_notif', icon: 'clock', sound: RawResourceAndroidNotificationSound('music'), largeIcon: DrawableResourceAndroidBitmap('clock'));
